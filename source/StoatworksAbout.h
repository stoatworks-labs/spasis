 ...
 *
 * GENERATED by stoatworks-backend/scripts/sync-about.py on 2026-09-06. Do not
...
namespace stoatworks::about
{
    ...
    inline constexpr auto hook = "The shape of the stereo and surround field, for Resolume";
