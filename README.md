...
**[v0.1.2](https://github.com/stoatworks-labs/spasis/releases/tag/v0.1.2)** — prebuilt for macOS and Windows. Pick your platform:
...
| Build | Download | Size |
| --- | --- | --- |
| Universal (Apple Silicon + Intel) · .dmg disk image | [`spasis-0.1.2-macos-universal.dmg`](https://github.com/stoatworks-labs/spasis/releases/download/v0.1.2/spasis-0.1.2-macos-universal.dmg) | 2.0 MB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .exe installer | [`spasis-0.1.2-windows-x86_64-setup.exe`](https://github.com/stoatworks-labs/spasis/releases/download/v0.1.2/spasis-0.1.2-windows-x86_64-setup.exe) | 304 KB |
